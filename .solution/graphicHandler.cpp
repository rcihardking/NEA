...
int graphics::mesh::readObj(std::string filepath) { // this code is CRAP CRAP CRAP!!! must fix
...
void graphics::mesh::draw() {
    ...
    GLuint loc0 = glGetUniformLocation(shaderID, "scale");
    GLuint loc1 = glGetUniformLocation(shaderID, "rotation");
    GLuint loc2 = glGetUniformLocation(shaderID, "translation");
    GLuint loc3 = glGetUniformLocation(shaderID, "proj");
