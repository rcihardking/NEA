...
//}
//
//graphics::staticMesh::staticMesh(std::string filepath, GLuint shader, GLuint texture) : shaderID{ shader }, textureID{ texture } {
...
//}
//
//graphics::staticMesh::~staticMesh() {
//	glDeleteBuffers(1, &vbo);
//	glDeleteVertexArrays(1, &vao);
//}
//
//void graphics::staticMesh::draw() {
